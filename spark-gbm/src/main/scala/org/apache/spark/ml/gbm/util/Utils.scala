    ...
    if (!kryoRegistered) {
      sc.getConf.registerKryoClasses(
        Array(
          ...
          classOf[DenseKVVector[Byte, Long]],
          ...
          classOf[DenseKVVector[Short, Long]],
          ...
          classOf[DenseKVVector[Int, Long]],
          ...
          classOf[SparseKVVector[Byte, Long]],
          ...
          classOf[SparseKVVector[Short, Long]],
          ...
          classOf[SparseKVVector[Int, Long]],
