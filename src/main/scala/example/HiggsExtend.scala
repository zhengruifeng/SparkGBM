...
object HiggsExtend {
  ...
  def main(args: Array[String]): Unit = {
    ...
    MLUtils.saveAsLibSVMFile(train2, "/tmp/zrf/HIGGS-DENSEEXT-Train")
    MLUtils.saveAsLibSVMFile(test2, "/tmp/zrf/HIGGS-DENSEEXT-Test")
    ...
    MLUtils.saveAsLibSVMFile(train3, "/tmp/zrf/HIGGS-SPARSEEXT-Train")
    MLUtils.saveAsLibSVMFile(test3, "/tmp/zrf/HIGGS-SPARSEEXT-Test")
